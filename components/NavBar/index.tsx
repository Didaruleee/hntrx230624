      ...
      {navbar && (
        <motion.section
          ...
          <motion.section
            ...
            exit={{ opacity: 0, x: '100%' }}
            transition={{ duration: 0.3 }}
            className="bg-white  md:min-w-[400px] xs:max-w-[280px] sm:max-w-[340px]  xs:min-h-[480px] sm:min-h-[480px] md:min-h-[600px]  fixed  top-0 right-0">
            ...
            <div className="flex justify-center ">
              <div className=" absolute bottom-0 text-gray-400 md:p-4 xs:p-2 ">
